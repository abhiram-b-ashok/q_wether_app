...
//
//
//        selectedLanguage = sharedPrefs.getInt("selectedLanguage", 1)
//        selectLanguage(selectedLanguage)
//
//        selectedTemperature = sharedPrefs.getString("selectedTemperature", "°C")?.toIntOrNull() ?: 1)
//        selectTemperature(selectedTemperature)
//
//        selectedWind = sharedPrefs.getInt("selectedWind", 1)
//        selectWind(selectedWind)
//
//        selectedTide = sharedPrefs.getInt("selectedTide", 1)
...
//                selectLanguage(1)
//                selectedLanguage = 1
//                sharedPrefs.edit().putInt("selectedLanguage", selectedLanguage).apply()
//            }
...
//                sharedPrefs.edit().putString("selectedTemperatureUnit", "°C" ).apply()
//            }
//            fahrenheitButton.setOnClickListener {
//                selectTemperature(2)
//                selectedTemperature = 2
//                sharedPrefs.edit().putString("selectedTemperatureUnit", "F").apply()
//            }
//            kelvinButton.setOnClickListener {
//                selectTemperature(3)
//                selectedTemperature = 3
//                sharedPrefs.edit().putString("selectedTemperatureUnit", "K").apply()
//            }
//            kmButton.setOnClickListener {
//                selectWind(1)
//                selectedWind = 1
//                sharedPrefs.edit().putString("selectedWind", "km/h").apply()
//            }
//            knotButton.setOnClickListener {
//                selectWind(2)
//                selectedWind = 2
//                sharedPrefs.edit().putString("selectedWind", "kt").apply()
//            }
//            msButton.setOnClickListener {
//                selectWind(3)
//                selectedWind = 3
//                sharedPrefs.edit().putString("selectedWind", "m/s").apply()
//            }
//            mphButton.setOnClickListener {
//                selectWind(4)
//                selectedWind = 4
//                sharedPrefs.edit().putString("selectedWind", "mph").apply()
//            }
//            mButton.setOnClickListener {
//                selectTide(1)
//                selectedTide = 1
//                sharedPrefs.edit().putString("selectedTide", "m").apply()
//            }
...
//
//
//            val selectedItemsSet = sharedPrefs.getStringSet(KEY_SELECTED_DASHBOARD_ITEMS, HashSet()) ?: HashSet()
//            list.forEach { item ->
...
//                sharedPrefs.edit().putStringSet(KEY_SELECTED_DASHBOARD_ITEMS, currentSelectedTitles).apply()
//            }
//
